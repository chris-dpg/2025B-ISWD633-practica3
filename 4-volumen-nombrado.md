...
```
docker run -d --name client-postgres --publish published=9500,target=80 -e PGADMIN_DEFAULT_PASSWORD=54321 -e PGADMIN_DEFAULT_EMAIL=admin@correo.com --network net-drupal dpage/pgadmin4
```
...
<img width="1919" height="938" alt="image" src="https://github.com/user-attachments/assets/bc37d9d6-b2e5-41b5-8332-05a1ae7d85a2" />

_La instalación puede tomar varios minutos, mientras espera realice un diagrama de los contenedores que ha creado en este apartado._

# COMPLETAR CON EL DIAGRAMA SOLICITADO
<img width="662" height="438" alt="image" src="https://github.com/user-attachments/assets/884f4b6c-0f70-4b24-b6c5-d53d962465f6" />
